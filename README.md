...
depcheck
```
When the above command is ran in the **Terminal**, I am presented with a list of React NPM Dependencies I can prune. Using this allows me to execute the following command and clean my Project.
```bash
